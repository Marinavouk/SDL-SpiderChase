#include "Pch.h"
#include "EndOfTimeState.h"

#include "Application.h"
#include "Handlers/AudioHandler.h"

bool CEndOfTimeState::OnEnter(void)
{
	...
	if (!m_TitleTextBlock.Create(m_pApplication, m_TextFont, "Your time is off!", { 200, 0, 0, 255 }))
		return false;
...
void CEndOfTimeState::OnExit(void)
{
	CTextureHandler& textureHandler = m_pApplication->GetTextureHandler();
	CFontHandler& fontHandler = m_pApplication->GetFontHandler();
	CAudioHandler& audioHandler = m_pApplication->GetAudioHandler();
...
void CEndOfTimeState::Update(const float deltaTime)
{
...
void CEndOfTimeState::Render(void)
{
